    ...
    connectedCallback() {
        ...
        }
        {
            ...
            this.root.appendChild(this.centerSvg);
            {
                ...
                diffAndSetAttribute(this.cursor, "points", "200," + center + " 170," + (center - 40) + " 150," + (center - 40) + " 150," + (center - 60) + " 100," + (center - 60) + " 100," + (center - 40) + " 0," + (center - 40) + " 0," + (center + 40) + " 100," + (center + 40) + " 100," + (center + 60) + " 150," + (center + 60) + " 150," + (center + 40) + " 170," + (center + 40));
                ...
                diffAndSetAttribute(baseCursorSvg, "y", (center - 40) + '');
                ...
                diffAndSetAttribute(rotatingCursorSvg, "y", (center - 60) + '');
        ...
        }
        {
            ...
            diffAndSetAttribute(this.tasBackground, "y", (this.height - 100) + '');
